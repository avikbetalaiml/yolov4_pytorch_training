...
import re
import mlflow
from allparameter import allparameter
from db import yolo4_db
...
'''
class yolov4_training:


    def __init__(self, project_id=None, epochs=None, frame_work=None, algo=None, alias_name = None):
    ...
    def mlflow_init(self):
        ...
        insert_data_obj = yolo4_db()
        insert_data = insert_data_obj.train_comp(run_id = run_id, project_id = self.project_id, epochs = self.epochs, frame_work = self.frame_work, algo = self.algo, alias_name = self.alias_name)
